    ...
    partial class BancoSafra : IBancoCNAB400
    {
        ...
        public void LerDetalheRetornoCNAB400Segmento1(ref Boleto boleto, string registro)
        {
            try
            {
                ...
                boleto.Banco.Beneficiario.ContaBancaria.Agencia = registro.Substring(17, 4);
                boleto.Banco.Beneficiario.ContaBancaria.DigitoAgencia = registro.Substring(21, 1);
                boleto.Banco.Beneficiario.ContaBancaria.Conta = registro.Substring(22, 8);
                boleto.Banco.Beneficiario.ContaBancaria.DigitoConta = registro.Substring(30, 1);
        ...
        private string GerarDetalheRemessaCNAB400Registro1(Boleto boleto, ref int numeroRegistroGeral)
        {
            try
            {
                ...
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0143, 004, 0, Beneficiario.ContaBancaria.Agencia, '0');
                reg.Adicionar(TTiposDadoEDI.ediNumericoSemSeparador_, 0147, 001, 0, Beneficiario.ContaBancaria.DigitoAgencia, '0');
